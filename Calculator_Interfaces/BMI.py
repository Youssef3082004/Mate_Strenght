...
class Calculator_BMI(Column):
    def __init__(self,page:Page):
        ...
        #! ==================================================== Interface Title ==============================================
        self.title_text = Text(value="BMI Score",color=Colors.BLACK54,size=25,font_family="Inter",weight=FontWeight.BOLD)
        ...
        self.row2 = Row(controls=[self.Height,self.Height_units],alignment=MainAxisAlignment.CENTER)
        self.row3 = Row(controls=[self.Weight,self.Weight_units],alignment=MainAxisAlignment.CENTER)
        self.row4 = Row(controls=[self.Calculate],alignment=MainAxisAlignment.CENTER)

        #! ========================================================= Controls =========================================================
        self.controls = [self.null,self.row0,self.row1,self.null,self.null,self.row2,self.row3,self.null,self.null,self.row4]



if __name__ == "__main__":
    def main(page:Page):
        page.add(Calculator_BMI(page))
