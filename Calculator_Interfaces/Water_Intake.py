...
class Calculator_Water(Column):
    def __init__(self,page:Page):
        ...
        #! ==================================================== Interface Title ==============================================
        self.title_text = Text(value="Water Intake",color=Colors.BLACK54,size=25,font_family="Inter",weight=FontWeight.BOLD)
        ...
        self.row2 = Row(controls=[self.Weight,self.Weight_units],alignment=MainAxisAlignment.CENTER)
...
if __name__ == "__main__":
    def main(page:Page):
        page.add(Calculator_Water(page))
